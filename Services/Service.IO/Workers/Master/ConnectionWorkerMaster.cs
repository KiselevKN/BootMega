...
{
    public class ConnectionWorkerMaster : IOWorkerBase<Tuple<int,DateTime>>
    {
        #region ctors

        public ConnectionWorkerMaster(string port, SerialPortSettings serialPortSettings, ILoggerFacade logger) : 
